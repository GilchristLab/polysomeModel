...
\begin{enumerate}
	...
	\item Our model does not explicitly capture the mechanism of translation, it just keeps track of the available spaces left on a transcript. As such the model would underestimate the actual effect of ribosomal interference
