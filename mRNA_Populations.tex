...
Figure1
	...
	\item Transcripts enter into the the population by being transcribed at a rate $\lambda$. 
	\item Transcripts can exist in one of two states: capped and uncapped which captures the both the mRNA protection and Translation capabilities of the 5' cap. 
	\item Capped transcripts are translationally competent, meaning that new ribosome can be loaded onto the transcript. 
	\item Nascent transcripts enter the population capped and devoid of ribosomes. 
	\item 

	\item Uncapped transcripts can no long initate new rounds of translation and are eventually completely degraded once  all ribosomes are off.
	\item Capped transcripts become uncapped through decapping ($\mu$).
	\item Trans
