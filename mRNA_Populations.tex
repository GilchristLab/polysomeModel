...
\item The model recapitulates empirical measurements of translation.
	...
	\item This is further corroborated with single molecule imaging analyses, which find low levels of ribosomal loading of 5/transcript (Morisaki 2016), 
	\end{enumerate}
\end{enumerate}
...
2. The inclusion of mRNA degradation effects shows that mRNA decay not only regulates transcript abundance, but also mean ribosomal load .


3. Co-translational decay may allow for decapped transcripts to provide substantial protein production under certain mRNA behaviors. 	

4. model limitations and extension


The model presented here displays interesting opportunities for further integration. 
	RFM at every level (not that applicable really)
	population level modeling (competition for ribosomes/trna)
	integration with models of transcription.
