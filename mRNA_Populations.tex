...
\newcommand{\mvechatstar}{\ensuremath{\mhatvec^*}\xspace}
...
In this study we develop and study a novel model of mRNA populations which includes the contributions of mRNA transcription, the initiation and termination of translation as well as mRNA decapping and degradation.
...
\begin{enumerate}
\item Although our model is only a very simplified description of protein translation, it includes several steps that have been left out of earlier models.
  \begin{enumerate}
  \item Detail 1
  \item Detail 2
  \item Detail 3      
  \end{enumerate}
\item  In addition to being more biologically realistic, structuring the mRNA population by its polysome classes (ribosome load) and the status of its 5' cap allows us to understand how the the rates mRNA production $\lambda$, decapping $\mu$, elongation $\tau$, and degradation $\delta$ shape the steady state distribution of a gene's mRNA population across polysome classes and capping state.
  Overall, we find that 
  \begin{enumerate}
  \item Capped mRNA population
    \begin{enumerate}
    \item Analytical and numerical solutions show that the transcription rate $\lambda$ acts as a scaling factor, such that the entire mRNA population is proportional to $\lambda$.
      (Explain why this is important in a sentence).
    \item The sum of the of capped mRNA classes $\mvechat$ is solely determined the ratio of $\lambda$ to the 5' decapping rate $\mu$, i.e. $\sum_{i = 0}^{i_{\imax}} \mhat_i= \lambda/mu$.
      \begin{enumerate}
      \item This result suggests that under biologically realistic conditions \ldots.
      \end{enumerate}
    \item Impact of $\kappa/\mu$
      \begin{enumerate}
      ...
      \item At very high and generally unrealistic values of $\kappa/\mu$, ....
      \end{enumerate}
    \end{enumerate}
  \item Decapped mRNA population
    ...
    \item The steady state abundance of the decapped, ribosome free mRNA class class  $\mhat_0^*$  is decoupled from the dynamics of the rest of the population.
      ...
      \begin{enumerate}
      \item The steady state abundance (density?) of $\mhat_0^* = \lambda/\delta$ and, thus, depends only on the ratio of the mRNA transcription rate $\lambda$ to the degradation rate $\delta$.
  ...
  \item Combined distributions of the capped and decapped polysome class
    \begin{enumerate}      
    \item Distribution is unimodal when...
    \item Becomes increasingly bimodal when...
    \item Increasing marking rate and scaled initiation rate both increase the proportion of transcripts in the decapped state.
      ...
      \item As expected, increasing $\mu$ results in an increase in the abundance of decapped transcripts \mvechatstar (relative to anything?)
      \item However, increasing ratio of initiation to elongation rates $\kappa/\tau$ also results in an increase of \mvechatstar.
      \item As $\kappa/tau$ (?) increases the MRL of the capped population \mvechat increases, transcripts enter the decapped state at higher polysomal classes and thus take longer to reach $m_0^*$.
        (Make terminology consistent with discussion about the general behavior of \mvechat above.)
      \end{enumerate}
    \end{enumerate}
  \end{enumerate}
\end{enumerate}

Integrate the following points into the points above
\begin{enumerate}
\item Increasing marking rate also decreases the MRL proportional to increasing scaled initiation rates. 
  \begin{enumerate}	
  \item  Under low marking rates ($\mu \sim 10^{-6}$ 1/s, Half-life ~ 1,500 minutes), MRL for the system comes almost entirely from the capped state. 
...
For example,
\begin{enumerate}
\item Previously observed polysome gradients (Lokdarshi 2020, Dasgupta 2023, Figure ?),
\item Ribo-seq (Weinberg 2016, Figure ?)
\item single molecule measurements of translation (Morisaki 2016, Yan 2016, Wang 2016, Wu 2016, Figure ?).         
\item Predicted capped to decapped mRNA ratios also align with empirical measurements (Pelechano 2015)
\item MRL is largely independent of the protein length (single molecule imaging of translation (Wu 2016), Figure ?).
\item Fraction of mRNA in the decapped class under XXX conditions are consistent with population wide estimates (Pelechano 2015, Figure ?). 
\end{enumerate}
...
\item	Our model's assumptions about the process of mRNA decapping, the continued competence of ribosomes present prior to decapping, and degradation of mRNA solely from the decapped and ribosome free class $m_0^*$  closely resembles the biological process of co-translational mRNA decay.
  \begin{enumerate}
  \item   The existence of co-translational mRNA decay is well established and is estimated to occur in $\sim 68\%$ of Arabadopsis genes (Sorenson 2018).
