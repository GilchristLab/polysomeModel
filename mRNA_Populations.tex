...
The interplay between marking rate and scaled initiation rates affect MRL and protein production

\item Marking rate impacts the MRL, but only for transcripts with high initiation rates. 
	\begin{enumerate}	
...
\item	Co-translational degradation may allow for decapped transcripts to provide substantial protein production.
	\begin{enumerate}
	\item The interplay between the ma
...
Model limitations, extensions and future work
